...
public class Story {
    public static void main(String[] args) {
        ...
        Personage Fluff = new Personage("Пух", home, Mood.NORMAL, true);
        Personage Owl = new Personage("Сова", home, Mood.NORMAL, true);
        Personage Ia = new Personage("Иа", forest, Mood.SAD, false);
